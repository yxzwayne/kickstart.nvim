...
vim.keymap.set('n', 'bn', ':bnext<CR>', { desc = '[B]uffer [N]ext', noremap = true, silent = true })
vim.keymap.set('n', 'bp', ':bprevious<CR>', { desc = '[B]uffer [P]revious', noremap = true, silent = true })
vim.keymap.set('n', 'bl', ':buffers<CR>', { desc = '[B]uffer [L]ist', noremap = true })
vim.keymap.set('n', 'bd', ':bdelete<CR>', { desc = '[B]uffer [D]elete', noremap = true })
...
end, { desc = 'Search by Grep (Telescope)' })
